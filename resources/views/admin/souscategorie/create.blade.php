...
@section('title','Ajouté Sous Categories')
@section('content')
        ...
        <form action="{{route('sousCategories.store')}}" method="POST"
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="val-username">Nom Sous Categorie Fr<span
                        class="text-danger"> *</span></label>
                <div class="col-md-6">
                    <input value="{{old('sous_categorie_fr')}}" name="sous_categorie_fr" type="text"
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="val-username">Nom Sous Categorie EN<span
                        class="text-danger"> *</span></label>
                <div class="col-md-6">
                    <input value="{{old('sous_categorie_en')}}" name="sous_categorie_en" type="text"
                           placeholder="Vous devez saisir un nom de sous categorie ici.."
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="val-username">Nom Sous Categorie AR<span
                        class="text-danger"> *</span></label>
                <div class="col-md-6">
                    <input value="{{old('sous_categorie_ar')}}" name="sous_categorie_ar" type="text"
                           placeholder="Vous devez saisir un nom de sous categorie ici.."
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="val-username">Réalisateur<span
                        class="text-danger">*</span></label>
                <div class="col-md-6">
                    <input value="{{old('director')}}" name="director" type="text"
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="val-username">Réalisateur AR<span
                        class="text-danger">*</span></label>
                <div class="col-md-6">
                    <input value="{{old('director_ar')}}" name="director_ar" type="text"
                           placeholder="Vous devez saisir un nom réalisateur ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('episode')}}" name="episode" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('season')}}" name="season" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('client')}}" name="client" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('client_ar')}}" name="client_ar" type="text"
                           placeholder="Vous devez saisir un nom du client ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('production')}}" name="production" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('production_ar')}}" name="production_ar" type="text"
                           placeholder="Vous devez saisir un nom de production ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('production_executif')}}" name="production_executif" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('production_executif_ar')}}" name="production_executif_ar" type="text"
                           placeholder="Vous devez saisir un titre pour exécutif production ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('synopsis_fr')}}" name="synopsis_fr" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('synopsis_en')}}" name="synopsis_en" type="text"
                           placeholder="Vous devez saisir synopsis ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('synopsis_ar')}}" name="synopsis_ar" type="text"
                           placeholder="Vous devez saisir synopsis ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('scenario_fr')}}" name="scenario_fr" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('scenario_en')}}" name="scenario_en" type="text"
                           placeholder="Vous devez saisir votre Scénario ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('scenario_ar')}}" name="scenario_ar" type="text"
                           placeholder="Vous devez saisir votre Scénario ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('agency_fr')}}" name="agency_fr" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('agency_ar')}}" name="agency_ar" type="text"
                           placeholder="Vous devez saisir le nom de l'agence ici.."
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('project_fr')}}" name="project_fr" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input value="{{old('project_ar')}}" name="project_ar" type="text"
                           placeholder="Vous devez saisir un titre de projet ici.."
